...
def render_context_section(
    ...
    lines = [
        ...
        "",
        "This section adds user, playlist, lyric, review, comment, or metadata context beside the local listening data.",
        "",
        "### Context source notes",
        "",
        "- Human notes and external files can supply imagery, memory, lyrics, credits, reviews, or historical context.",
        "- Source type and timestamp are shown so the online AI can understand where each piece of context came from.",
        "- Playlist names can be read as private naming, style clusters, label entries, research folders, test sets, memory anchors, metadata, or unknown context.",
        "",
        "### Context classification",
        "",
        "Possible context types: private naming, style cluster, label entry, single-work research, test/probe set, memory anchor, external metadata, or unknown.",
        "",
    ]
    if playlist_context:
